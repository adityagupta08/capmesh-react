...
class Organization extends Component {
   state={
    ...
    verifyCompanyID(e){
        ...
        var url = 'http://localhost:8080/rest/api/orgs/uniqueCompanyID';
...
verifyEmail(e){
        ...
        var url = 'http://localhost:8080/rest/api/users-orgs/uniqueEmail';
...
submitOrgsDetails(e){
    ...
    ||a.areaOfWorkError != null||a.passwordError != null||a.confirmPasswordError != null ){
        ...
        var url = 'http://localhost:8080/rest-api/orgs/signup';
